...
(function () {
  ...
  (function () {
    ...
    a.Log.AddLine = function (d) {
      ...
      e.appendChild(
        document.createTextNode(h + 'ms ' + c.toLocaleTimeString())
      );
  ...
  (function () {
    ...
    b.prototype.ToDurationString = function () {
      ...
      var f =
        c.Months[this.FromDate.getMonth()] + ' ' + this.FromDate.getDate();
          ...
          if (
            ...
            'horizontal' == ap.settings.mode
              ...
              ((0 == ap.active.index && g > 0) || (ap.active.last && 0 > g))
                ...
                ? (0 > g ? am.goToNextSlide() : am.goToPrevSlide(),
                  am.stopAuto())
                : aA(d, 'reset', 200);
          }
            ...
            if (
              ...
              if (!ap.settings.infiniteLoop && ap.carousel && ap.active.last) {
                if ('horizontal' == ap.settings.mode) {
                  ...
                  (f = r.position()),
                    (u = ap.viewport.width() - r.outerWidth());
                } else {
              ...
              if ('undefined' != typeof f) {
                var m =
                  'horizontal' == ap.settings.mode ? -(f.left - u) : -f.top;
  ...
  (function () {
    ...
    MadCap.WebHelp.FeedbackController = function (g) {
      ...
      this.StartActivateUser = function (m, r, p) {
        ...
        var y = FMCGetChildNodeByAttribute(
          m.documentElement,
          'Name',
          'Username'
        );
        ...
        var x = FMCGetChildNodeByAttribute(
          m.documentElement,
          'Name',
          'LastName'
        );
        var s = FMCGetAttribute(x, 'Value');
        var w = FMCGetChildNodeByAttribute(
          m.documentElement,
          'Name',
          'Country'
        );
  ...
  MadCap.WebHelp.HelpSystem = function (o, s, j, e, m) {
    ...
    var f = new MadCap.WebHelp.TocFile(
      this,
      MadCap.WebHelp.TocFile.TocType.Toc
    );
    var d = null;
    ...
    this.Load = function (K) {
      MadCap.Utilities.Xhr.Load(
        ...
        function (Y) {
          ...
          this.LiveHelpServer = Y.documentElement.getAttribute(
            'LiveHelpServer'
          );
          ...
          if (S.length > 0 && S[0].getElementsByTagName('Url').length > 0) {
            var X = Y.getElementsByTagName(
              'Subsystems'
            )[0].getElementsByTagName('Url');
    ...
    this.GetPatchedPath = function (K) {
      ...
      if (this.UseCustomTopicFileExtension) {
        K = new MadCap.Utilities.Url(K).ToExtension(
    ...
    this.FindNode = function (L, N, M, O, K) {
      h.LoadToc([L, K]).then(function (U) {
        ...
        var P;
        if (!M.IsAbsolute) {
          var R = !MadCap.String.IsNullOrEmpty(Q.FullPath)
            ? Q.CombinePath(M)
            : M;
  ...
  (function () {
    ...
    function au(a2) {
      ...
      $('#search-field, #search-field-sidebar, .search-field').keypress(
        function (a4) {
          if (a4.which != 13) {
            return;
          }
    ...
    function J(a2) {
      ...
      if (a0.indexOf(aZ) == 0) {
        var aY = MadCap.WebHelp.Search.SearchQuery.Parse(
          a0.substring(aZ.length)
        );
    ...
    function aj(ba, bi, a2) {
      ...
      for (var bh = 0; bh < a2.Activities.length; bh++) {
        ...
        a1.setAttribute(
          'href',
          a4 + '#!streams/' + bl.CreatedBy + '/activities'
        );
    ...
    MadCap.Default.ApplySkin = function (ba) {
      ...
      if (
        ba.Toolbar != null &&
        MadCap.String.IsNullOrEmpty(ba.Toolbar.Buttons)
      ) {
        $('.buttons').remove();
      }
      if (
        !MadCap.String.IsNullOrEmpty(ba.Version) &&
        parseInt(ba.Version) >= 2
      ) {
        if (aF != null) {
    ...
    function H() {
      MadCap.Utilities.CrossFrame.PostMessageRequest(
        ...
        function (a5) {
          ...
          var a0 = MadCap.String.EndsWith(a4.FullPath, '/')
            ? a4
            : a4.ToFolder();
          aY = aY.ToRelative(a0);
          if (a1 != null) {
    ...
    MadCap.Utilities.CrossFrame.AddMessageHandler(function (
      a7,
      a4,
      bk,
      bl,
  ...
  (function () {
    ...
    a.prototype.LoadTopic = function (g) {
      var f = $.Deferred();
      var e = MadCap.Utilities.GetChunkId(
        this.TopicChunkMap,
        g,
        function (i, h) {
          if (i < h) {
    ...
    a.prototype.LoadStem = function (j) {
      var g = this;
      var f = $.Deferred();
      var i = MadCap.Utilities.GetChunkIds(
        this.StemChunkMap,
        j,
        function (l, k) {
  ...
  // Restore previous jquery version object
  $.noConflict(true);
})();
