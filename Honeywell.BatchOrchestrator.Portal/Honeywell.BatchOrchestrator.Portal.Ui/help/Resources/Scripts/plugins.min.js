...
(function (f, h, c) {
  ...
  if (a && d) {
    ...
    j = i.placeholder = function () {
      return this.filter((a ? 'textarea' : ':input') + '[placeholder]')
        .not('.placeholder')
        .bind('focus.placeholder', b)
        .bind('blur.placeholder', e)
    ...
    if (k.val() === k.attr('placeholder') && k.hasClass('placeholder')) {
      if (k.data('placeholder-password')) {
        k.hide()
          ...
          .show()
          .focus()
          .attr('id', k.removeAttr('id').data('placeholder-id'));
      } else {
      ...
      if (n.is(':password')) {
        if (!n.data('placeholder-textinput')) {
          ...
          o.removeAttr('name')
            ...
            .data('placeholder-id', m)
            .bind('focus.placeholder', b);
          n.data('placeholder-textinput', o)
            .data('placeholder-id', m)
            .before(o);
        }
...
(function (e, t, n) {
  var r = n('#topMenu'),
    i = 'click.fndtn';
  if (r.length > 0) r.css('margin-top', r.height() * -1);
  var s = n('#sidebarButton');
  if (s.length > 0) {
    n('#sidebarButton').on(i, function (e) {
      e.preventDefault();
      n('body').toggleClass('active');
    });
  }
  var o = n('#menuButton');
  if (o.length > 0) {
    n('#menuButton').on(i, function (e) {
      e.preventDefault();
      n('body').toggleClass('active-menu');
    });
  }
  var u = n('#switchPanels');
  if (u.length > 0) {
    n('#switchPanels dd').on(i, function (e) {
      e.preventDefault();
      var t = n(this).children('a').attr('href'),
        r = n(t).index();
      n(this).toggleClass('active').siblings().removeClass('active');
      n(t)
        .parent()
        .css('left', r * -100 + '%');
    });
  }
  n('#nav li a').on(i, function (e) {
    e.preventDefault();
    var t = n(this).attr('href'),
      r = n(t);
    n('html, body').animate({ scrollTop: r.offset().top }, 300);
  });
})(this, document, jQuery);
...
<mailto:jb@eaio.com>
*/
(jQuery.fn.highlight = function (e, t, n) {
  function d(e, o, h) {
    if (((this.skip = 0), 3 == e.nodeType)) {
      if (e.data.length != h(e.data).length || o.length != h(o).length)
        return !1;
      var l = h(o),
        r = h(e.data);
      if (
        !/MCHelpControl/.test(e.parentNode.className) &&
        (/\s/.test(o) || new RegExp('\\s*' + l + '\\s*').test(r))
      ) {
        var s = h(e.data).indexOf(h(o));
        if (s >= 0) {
          var c = document.createElement(n);
          t && (c.className = t);
          var p = e.splitText(s),
            u = (p.splitText(h(o).length), p.cloneNode(!0));
          c.appendChild(u), p.parentNode.replaceChild(c, p), (this.skip = 1);
        } else this.skip = 0;
      }
    } else if (
      1 == e.nodeType &&
      ...
      for (var N = 0; N < e.childNodes.length; ++N)
        N += d(e.childNodes[N], o, i)
          ? this.skip
          : d(e.childNodes[N], o, a)
          ? this.skip
          : this.skip;
    return !0;
  }
  ...
  return this.length && e && e.length
    ? this.each(function () {
        1 == this.childNodes.length &&
          'undefined' == typeof this.recoveryData &&
          (this.recoveryData = this.firstChild.data),
          d(this, e, i) || d(this, e, a) || d(this, e, o);
      })
    : this;
}),
  (jQuery.fn.removeHighlight = function (e, t) {
    function n(e) {
      for (var t = 0; t < e.childNodes.length; t++)
        if (e.childNodes[t].nodeType == Node.TEXT_NODE) {
          for (
            var n = new Array(), d = e.childNodes[t].nextSibling;
            null != d && d.nodeType == Node.TEXT_NODE;

          )
            (e.childNodes[t].data += d.data), n.push(d), (d = d.nextSibling);
    ...
    function d() {
      ...
      e.appendChild(document.createTextNode('')),
        ...
        e.appendChild(document.createTextNode('を終了しますa')),
        e.appendChild(document.createTextNode('♋uü')),
        e.appendChild(document.createTextNode('is-a')),
        e.appendChild(document.createTextNode('nother-testｽ')),
        e.appendChild(document.createTextNode('¤xyz')),
        e.appendChild(document.createTextNode('xyz¤Ø')),
        document.getElementsByTagName('head')[0].appendChild(e),
        e.normalize();
      var t =
        1 != e.childNodes.length ||
        e.childNodes[0].length !=
          'this-を終了しますa♋uüis-another-testｽ¤xyzxyz¤Ø'.length;
      return document.getElementsByTagName('head')[0].removeChild(e), t;
    }
    function i(e) {
      for (var t = e.childNodes.length > 1, n = 0; n < e.childNodes.length; n++)
        e.childNodes[n].nodeType == Node.ELEMENT_NODE && (t = !1);
      return t;
    }
    return (
      t || (t = 'span'),
      this.find(t + '.' + e)
        .each(function () {
          var e = this,
            t = e.parentNode;
          if (null != t && null != t.firstChild) {
            var a = e.firstChild.cloneNode();
            if ((t.replaceChild(a, e), d())) n(t);
            else {
              var o = t.firstChild.wholeText;
              t.normalize(),
                'undefined' != typeof t.recoveryData
                  ? 1 == t.childNodes.length &&
                    t.childNodes[0].wholeText != t.recoveryData
                    ? (t.innerText = t.recoveryData)
                    : i(t) && (t.innerText = t.recoveryData)
                  : t.childNodes[0].data &&
                    void 0 != o &&
                    o.length > t.childNodes[0].data.length &&
                    (t.innerText = o);
            }
          }
        })
