...
(function (e, t, n, r) {
  ...
  i.prototype.deviceIsIOSWithBadTarget =
    i.prototype.deviceIsIOS && /OS ([6-9]|\d{2})_\d/.test(navigator.userAgent);
  ...
  i.prototype.sendClick = function (e, r) {
    'use strict';
    var i, s;
    if (n.activeElement && n.activeElement !== e) {
  ...
  i.prototype.findControl = function (e) {
    ...
    if (e.htmlFor) {
      return n.getElementById(e.htmlFor);
    }
  ...
  i.prototype.onTouchEnd = function (e) {
    ...
    if (this.deviceIsIOSWithBadTarget) {
      ...
      a =
        n.elementFromPoint(u.pageX - t.pageXOffset, u.pageY - t.pageYOffset) ||
        a;
    ...
    if (s === 'label') {
      ...
      if (
        e.timeStamp - i > 100 ||
        (this.deviceIsIOS && t.top !== t && s === 'input')
      ) {
        this.targetElement = null;
        return false;
      }
  ...
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = i.attach;
    module.exports.FastClick = i;
  } else {
    t.FastClick = i;
  }
  e(function () {
  ...
  t.Foundation = {
    ...
    init_lib: function (e, t) {
      if (this.libs.hasOwnProperty(e)) {
        ...
        if (t && t.hasOwnProperty(e)) {
          return this.libs[e].init.apply(this.libs[e], [this.scope, t[e]]);
        }
    ...
    lib_methods: {
      ...
      data_options: function (t) {
        function a(e) {
          return (
            !isNaN(e - 0) && e !== null && e !== '' && e !== false && e !== true
          );
        }
        function f(t) {
      ...
      register_media: function (t, n) {
        if (Foundation.media_queries[t] === r) {
          ...
          Foundation.media_queries[t] = o(e('.' + n).css('font-family'));
        }
      },
